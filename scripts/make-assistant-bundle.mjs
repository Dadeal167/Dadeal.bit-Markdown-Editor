...
/* 版本号从 package.json 读，别再硬编码 —— 之前写死 v1.0.0，
   发 1.1 时差点把新包覆盖到旧文件名上（发布的附件名是永久的，改不了）。 */
const VERSION = `v${JSON.parse(readFileSync(resolve(ROOT, 'package.json'), 'utf8')).version}`

...
const MARKERS = {
  ...
  'editor/mathDiagnostics.ts': ['导出公式诊断', '公式诊断-'],
  ...
  'editor/theme.ts': ['md-editor-theme-v1', 'data-theme', 'zh-statusbar__clock'],
  ...
  'editor/usageTime.ts': ['用时：', 'dadealbit@gmail.com', '收件人：'],
  'editor/search.ts': ['zh-search-hit', 'Ctrl+F'],
  'editor/SearchBox.tsx': ['zh-search__input', 'zh-search__item'],
  'editor/FeedbackModal.tsx': ['使用反馈', 'zh-feedback__todo', '复制反馈内容'],
  'editor/codeLanguages.ts': ['zh-codeblock__lang', 'javascript'],
  'editor/types.ts': ['__EDITOR__'],

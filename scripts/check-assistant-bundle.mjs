...
if (!existsSync(resolve(EXTRACT, '启动器', '开始使用.bat'))) {
...
const must = [
  ...
  '使用说明.txt',
  // .bat 统一放在「启动器」子文件夹里（根目录只留编辑器、说明和两个数据文件夹）
  '启动器/开始使用.bat',
  '启动器/停止助手.bat',
  '启动器/启动知乎助手.bat',
  '启动器/安装助手自启 autostart-on.bat',
  '启动器/取消助手自启 autostart-off.bat',
  '启动器/_open-editor.ps1',
  'runtime/node.exe',
